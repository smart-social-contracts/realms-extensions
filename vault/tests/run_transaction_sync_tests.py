...
def deploy_realm_backend() -> bool:
    ...
    try:
        ...
        realms_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../.."))
        ...
        if init_result:
            ...
            print_warning("Vault extension initialization returned no result (may already be initialized)")
...
def run_all_tests() -> dict:
    ...
    results["Multiple deposits accumulate balance"] = test_multiple_deposits_accumulate_balance()
