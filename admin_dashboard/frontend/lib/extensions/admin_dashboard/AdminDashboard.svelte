<script>
  ...
  // Backend now uses get_objects_paginated(class_name, page_num, page_size, order)
  // Note: Candid field names are camelCase (objectsListPaginated, not ObjectsListPaginated)
  const entityConfigs = [
    { name: 'users', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('User', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => usersPage, perPage: () => usersPerPage, pagination: () => usersPagination, onPageChange: handleUsersPageChange },
    { name: 'mandates', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('Mandate', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => mandatesPage, perPage: () => mandatesPerPage, pagination: () => mandatesPagination, onPageChange: handleMandatesPageChange },
    { name: 'tasks', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('Task', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => tasksPage, perPage: () => tasksPerPage, pagination: () => tasksPagination, onPageChange: handleTasksPageChange },
    { name: 'transfers', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('Transfer', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => transfersPage, perPage: () => transfersPerPage, pagination: () => transfersPagination, onPageChange: handleTransfersPageChange },
    { name: 'instruments', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('Instrument', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => instrumentsPage, perPage: () => instrumentsPerPage, pagination: () => instrumentsPagination, onPageChange: handleInstrumentsPageChange },
    { name: 'codexes', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('Codex', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => codexesPage, perPage: () => codexesPerPage, pagination: () => codexesPagination, onPageChange: handleCodexesPageChange },
    { name: 'organizations', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('Organization', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => organizationsPage, perPage: () => organizationsPerPage, pagination: () => organizationsPagination, onPageChange: handleOrganizationsPageChange },
    { name: 'disputes', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('Dispute', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => disputesPage, perPage: () => disputesPerPage, pagination: () => disputesPagination, onPageChange: handleDisputesPageChange },
    { name: 'licenses', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('License', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => licensesPage, perPage: () => licensesPerPage, pagination: () => licensesPagination, onPageChange: handleLicensesPageChange },
    { name: 'trades', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('Trade', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => tradesPage, perPage: () => tradesPerPage, pagination: () => tradesPagination, onPageChange: handleTradesPageChange },
    { name: 'realms', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('Realm', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => realmsPage, perPage: () => realmsPerPage, pagination: () => realmsPagination, onPageChange: handleRealmsPageChange },
    { name: 'proposals', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('Proposal', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => proposalsPage, perPage: () => proposalsPerPage, pagination: () => proposalsPagination, onPageChange: handleProposalsPageChange },
    { name: 'votes', fetch: (page_num = 0, page_size = 5) => backend.get_objects_paginated('Vote', page_num, page_size, 'desc'), dataPath: 'objectsListPaginated.objects', paginationPath: 'objectsListPaginated.pagination', page: () => votesPage, perPage: () => votesPerPage, pagination: () => votesPagination, onPageChange: handleVotesPageChange }
  ];
