...
def async_task():
    ...
    try:
        ...
        if result.get("success"):
            ...
            print_error(f"✗ Extension call failed: {result.get('error', 'Unknown error')}")
    ...
    try:
        ...
        result = call_realm_extension("admin_dashboard", "import_data", {
            "format": "json",
            "data": sample_data
        })
    ...
    return {
        "success": True,
        "message": "Admin dashboard tests completed"
    }
